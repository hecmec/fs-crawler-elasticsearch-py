...
TikaJarPath = r"C:\Projets\Portail_Intranet_Search\fs-crawler-py\tika\tika_server"
TikaFilesPath = r"C:\Projets\Portail_Intranet_Search\fs-crawler-py\tika\tika_server"
...
#TikaServerJar = r"C:\Projets\elasticsearch-2.2.0\jpe_temp\tika_server\tika-server.jar"
...
def detectLang1(option, urlOrPath, serverEndpoint=ServerEndpoint, verbose=Verbose, tikaServerJar=TikaServerJar, 
    ...
    with open(path, 'rb') as file_stream:
        status, response = callServer('put', serverEndpoint, service, file_stream, {'Accept': responseMimeType}, verbose, tikaServerJar)
